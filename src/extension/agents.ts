 ...
 * Ported from the official Pi subagent demo.
 */
 ...
 * - scope "user": load from user agent dir (getAgentDir()/agents)
 * - scope "project": load from .pi/agents/ relative to cwd (walks up)
 * - scope "both": project first, then user (dedup by name, project wins)
 */
